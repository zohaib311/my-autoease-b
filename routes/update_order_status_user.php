...
try {
    ...
    error_log("Query executed: SELECT id, created_at FROM orders WHERE id = $order_id AND user_id = $user_id");
    
    if ($result->num_rows === 0) {
        error_log("No rows found for order_id: $order_id and user_id: $user_id");
